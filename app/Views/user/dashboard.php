...
<?= $this->section('content'); ?>
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav text-bg-info sidebar sidebar-dark accordion" id="accordionSidebar">
        <div class="row justify-content-center text-center">

            <div class="col-mb-3">

                <img src="/img/bspji.png" class="shadow" width="30" height="34"  alt="Maje Graphics" width="auto" />
